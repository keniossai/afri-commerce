<div>
                            ...
                            @foreach (Cart::instance('wishlist')->content() as $item)
                                <tr>
                                    <td class="product-thumbnail">
                                        <div class="p-relative">
                                            <a href="product-default.html">
                                                <figure>
                                                    <img src="{{asset('maya/images/shop/product-')}}{{$item->model->id}}-1.jpg" alt="product" width="300" height="338">
                                                </figure>
                                            </a>
                                            <button type="submit" class="btn btn-close" wire:click.prevent="removeFromWishlist({{$item->model->id}})"><i class="fas fa-trash"></i></button>
                                        </div>
                                    </td>
                                    ...
                                    <td class="product-price">
                                        <ins class="new-price">₦{{$item->model->regular_price}}</ins>
                                    </td>
                                    <td class="product-stock-status">
                                        <span class="wishlist-in-stock">{{$item->model->stock_status}}</span>
                                    </td>
    ...
    @else
        <div class="container text-center mb-10">
            <div class="">
                <img class="cart-image" src="{{asset('maya/images/carts/wishlist.png')}}" alt="">
