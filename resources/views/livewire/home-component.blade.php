<div>
    <main class="main">
        <div class="container">
                        ...
                        <div class="swiper-container swiper-theme animation-slider pg-inner" data-swiper-options="{
                            ...
                            <div class="swiper-wrapper row gutter-no cols-1">
                                <div class="swiper-slide intro-slide intro-slide1 banner banner-fixed br-sm"
                                    style="background-image: url('{{asset('maya')}}/images/demos/demo11/slides/slide-1.jpg'); background-color: #5D5E62;">
                                    <div class="banner-content x-50 w-100 text-center">
                                        ...
                                        <!-- <figure class="slide-animate floating-item" data-animation-options="{
                                            ...
                                            <img src="{{asset('maya')}}/images/demos/demo5/slides/bicycle.png" alt="Bicycle"
                                ...
                                <div class="swiper-slide intro-slide intro-slide2 banner banner-fixed br-sm"
                                    style="background-image: url({{asset('maya')}}/images/demos/demo5/slides/slide-2.jpg); background-color: #EBEDEC;">
                                ...
                                <div class="swiper-slide intro-slide intro-slide3 banner banner-fixed br-sm"
                                    style="background-image: url({{asset('maya')}}/images/demos/demo5/slides/slide-3.jpg); background-color: #E0E0DE;">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-6 mb-4">
                                <div class="category-banner banner banner-fixed br-sm">
                                    <figure>
                                        <img src="{{asset('maya')}}/images/demos/demo5/categories/1-1.jpg" alt="Category"
                            ...
                            <div class="col-md-12 col-xs-6 mb-4">
                                <div class="category-banner banner banner-fixed br-sm">
                                    <figure>
                                        <img src="{{asset('maya')}}/images/demos/demo5/categories/1-2.jpg" alt="Category"
            ...
            <div class="swiper-container appear-animate icon-box-wrapper br-sm mt-6 mb-6 swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events swiper-container-rtl fadeIn appear-animation-visible" data-swiper-options="{
                'slidesPerView': 1,
                'loop': true,
                'breakpoints': {
                    '576': {
                ...
                <div class="swiper-wrapper  shipping-slider" id="swiper-wrapper-913dd6dea1f5cc39" aria-live="polite" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                    <div class="swiper-slide icon-box icon-box-side icon-box-primary swiper-slide-active" style="width: 309.5px;margin-left: 0;" role="group" aria-label="1 / 4">
                    ...
                    <div class="swiper-slide icon-box icon-box-side icon-box-primary swiper-slide-next" style="width: 309.5px;" role="group" aria-label="2 / 4">
                    ...
                    <div class="swiper-slide icon-box icon-box-side icon-box-primary icon-box-money" style="width: 309.5px;" role="group" aria-label="3 / 4">
                    ...
                    <div class="swiper-slide icon-box icon-box-side icon-box-primary icon-box-chat mt-0" style="width: 309.5px;" role="group" aria-label="4 / 4">
                ...
                <div class="swiper-wrapper row cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                        ...
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/1-1-1.jpg" alt="Product"
                                        width="300" height="338">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/1-1-2.jpg" alt="Product"
                                        width="300" height="338">
                                </a>
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/1-2.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/1-3.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/1-4-1.jpg" alt="Product"
                                        width="300" height="338">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/1-4-2.jpg" alt="Product"
                                        width="300" height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/1-5.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
            ...
            <div class="category-banner-wrapper appear-animate row mb-5">
                <div class="col-md-6 mb-4">
                    <div class="banner banner-fixed br-sm">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/categories/2-1.jpg" alt="Category Banner"
                ...
                <div class="col-md-6 mb-4">
                    <div class="banner banner-fixed br-sm">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/categories/2-2.jpg" alt="Category Banner"
                    ...
                    <div class="swiper-wrapper row cols-xl-4 cols-md-3 cols-sm-2 cols-1">
                            ...
                            <div class="vendor-widget-banner">
                                <figure class="vendor-banner">
                                    <a href="vendor-dokan-store.html">
                                        <img src="{{asset('maya')}}/images/demos/demo3/vendors/1.jpg" alt="Vendor Banner"
                                ...
                                <div class="vendor-details">
                                    <figure class="vendor-logo">
                                        <a href="vendor-dokan-store.html">
                                            <img src="{{asset('maya')}}/images/demos/demo3/vendors/brand-1.jpg"
                        ...
                        <div class="swiper-slide vendor-widget">
                            <div class="vendor-widget-banner">
                                <figure class="vendor-banner">
                                    <a href="vendor-dokan-store.html">
                                        <img src="{{asset('maya')}}/images/demos/demo3/vendors/2.jpg" alt="Vendor Banner"
                                ...
                                <div class="vendor-details">
                                    <figure class="vendor-logo">
                                        <a href="vendor-dokan-store.html">
                                            <img src="{{asset('maya')}}/images/demos/demo3/vendors/brand-2.jpg"
                                                alt="Vendor Logo" width="90" height="90" />
                                        </a>
                                    </figure>
                                    <div class="vendor-personal">
                        ...
                        <div class="swiper-slide vendor-widget">
                            <div class="vendor-widget-banner">
                                <figure class="vendor-banner">
                                    <a href="vendor-dokan-store.html">
                                        <img src="{{asset('maya')}}/images/demos/demo3/vendors/3.jpg" alt="Vendor Banner"
                                ...
                                <div class="vendor-details">
                                    <figure class="vendor-logo">
                                        <a href="vendor-dokan-store.html">
                                            <img src="{{asset('maya')}}/images/demos/demo3/vendors/brand-3.jpg"
                                                alt="Vendor Logo" width="90" height="90" />
                                        </a>
                                    </figure>
                                    <div class="vendor-personal">
                        ...
                        <div class="swiper-slide vendor-widget">
                            <div class="vendor-widget-banner">
                                <figure class="vendor-banner">
                                    <a href="vendor-dokan-store.html">
                                        <img src="{{asset('maya')}}/images/demos/demo3/vendors/4.jpg" alt="Vendor Banner"
                                ...
                                <div class="vendor-details">
                                    <figure class="vendor-logo">
                                        <a href="vendor-dokan-store.html">
                                            <img src="{{asset('maya')}}/images/demos/demo3/vendors/brand-4.jpg"
                                                alt="Vendor Logo" width="90" height="90" />
                                        </a>
                                    </figure>
                                    <div class="vendor-personal">
                ...
                <div class="row grid grid-type">
                                ...
                                <div class="col-md-6">
                                    <div class="product-gallery mb-0">
                                        <figure class="product-image">
                                            <img src="{{asset('maya')}}/images/demos/demo5/products/2-1.jpg"
                                                data-zoom-image="{{asset('maya')}}/images/demos/demo5/products/2-1.jpg"
                    ...
                    <div class="grid-item grid-item-widget">
                        <div class="product product-widget">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/2-2.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                            </figure>
                            <div class="product-details">
                    ...
                    <div class="grid-item grid-item-widget">
                        <div class="product product-widget">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/2-3.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                            </figure>
                            <div class="product-details">
                    ...
                    <div class="grid-item grid-item-widget">
                        <div class="product product-widget">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/2-4.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                            </figure>
                            <div class="product-details">
                    ...
                    <div class="grid-item grid-item-widget">
                        <div class="product product-widget">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/2-5.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                            </figure>
                            <div class="product-details">
                    ...
                    <div class="grid-item grid-item-widget">
                        <div class="product product-widget">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/2-6.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                            </figure>
                            <div class="product-details">
                    ...
                    <div class="grid-item grid-item-widget">
                        <div class="product product-widget">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/2-7.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                            </figure>
                            <div class="product-details">
                    ...
                    <div class="grid-item grid-item-widget">
                        <div class="product product-widget">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/2-8.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                            </figure>
                            <div class="product-details">
                    ...
                    <div class="grid-item grid-item-widget">
                        <div class="product product-widget">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/2-9.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                            </figure>
                            <div class="product-details">
        ...
        <div class="container mt-10 pt-2">
            <div class="banner banner-simple appear-animate br-sm mb-10" style="background-image: url({{asset('maya')}}/images/demos/demo5/banners/1.jpg);
                ...
                <figure class="skrollable">
                    <img src="{{asset('maya')}}/images/demos/demo5/banners/ski.png" alt="Banner"
                ...
                <div class="swiper-wrapper row cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/3-1-1.jpg" alt="Product"
                                        width="300" height="338">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/3-1-2.jpg" alt="Product"
                                        width="300" height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/3-2.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/3-3.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/3-4-1.jpg" alt="Product"
                                        width="300" height="338">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/3-4-2.jpg" alt="Product"
                                        width="300" height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/3-5.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
            ...
            <div class="row grid grid-float appear-animate">
                <div class="col-lg-6 grid-item height-x2 grid-item-lg">
                    <div class="banner banner-fixed br-sm">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/banners/2-1.jpg" alt="Banner" width="680"
                ...
                <div class="col-lg-6 grid-item height-x1 grid-item-md">
                    <div class="banner banner-fixed br-sm">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/banners/2-2.jpg" alt="Banner" width="680"
                ...
                <div class="col-lg-3 col-sm-6 grid-item height-x1 grid-item-sm">
                    <div class="banner banner-fixed br-sm">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/banners/2-3.jpg" alt="Banner" width="330"
                ...
                <div class="col-lg-3 col-sm-6 grid-item height-x1 grid-item-sm">
                    <div class="banner banner-fixed br-sm">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/banners/2-4.jpg" alt="Banner" width="330"
                ...
                <div class="swiper-wrapper row cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/4-1-1.jpg" alt="Product"
                                        width="300" height="338">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/4-1-2.jpg" alt="Product"
                                        width="300" height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/4-2.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/4-3.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/4-4-1.jpg" alt="Product"
                                        width="300" height="338">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/4-4-2.jpg" alt="Product"
                                        width="300" height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/4-5.jpg" alt="Product" width="300"
                                        height="338">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
            ...
            <div class="swiper-container swiper-theme  brands-wrapper br-sm mb-10 appear-animate"
                ...
                <div class="swiper-wrapper row cols-xl-8 cols-lg-6 cols-md-4 cols-sm-3 cols-2">
                    ...
                    <div class="swiper-slide">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/brands/1.png" alt="Brand" width="310"
                                height="180" />
                        </figure>
                    </div>
                    <div class="swiper-slide">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/brands/2.png" alt="Brand" width="310"
                                height="180" />
                        </figure>
                    </div>
                    <div class="swiper-slide">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/brands/3.png" alt="Brand" width="310"
                                height="180" />
                        </figure>
                    </div>
                    <div class="swiper-slide">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/brands/4.png" alt="Brand" width="310"
                                height="180" />
                        </figure>
                    </div>
                    <div class="swiper-slide">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/brands/5.png" alt="Brand" width="310"
                                height="180" />
                        </figure>
                    </div>
                    <div class="swiper-slide">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/brands/6.png" alt="Brand" width="310"
                                height="180" />
                        </figure>
                    </div>
                    <div class="swiper-slide">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/brands/7.png" alt="Brand" width="310"
                                height="180" />
                        </figure>
                    </div>
                    <div class="swiper-slide">
                        <figure>
                            <img src="{{asset('maya')}}/images/demos/demo5/brands/8.png" alt="Brand" width="310"
                                height="180" />
                        </figure>
                    </div>
                </div>
            ...
            <div class="swiper-container swiper-theme post-wrapper appear-animate mb-3" data-swiper-options="{
                ...
                <div class="swiper-wrapper row cols-lg-4 cols-md-3 cols-sm-2 cols-1">
                    <div class="swiper-slide post text-center overlay-zoom">
                        <figure class="post-media br-sm">
                            <a href="post-single.html">
                                <img src="{{asset('maya')}}/images/demos/demo5/blogs/1.jpg" alt="Post" width="280" height="180"
                    ...
                    <div class="swiper-slide post text-center overlay-zoom">
                        <figure class="post-media br-sm">
                            <a href="post-single.html">
                                <img src="{{asset('maya')}}/images/demos/demo5/blogs/2.jpg" alt="Post" width="280" height="180"
                    ...
                    <div class="swiper-slide post text-center overlay-zoom">
                        <figure class="post-media br-sm">
                            <a href="post-single.html">
                                <img src="{{asset('maya')}}/images/demos/demo5/blogs/3.jpg" alt="Post" width="280" height="180"
                    ...
                    <div class="swiper-slide post text-center overlay-zoom">
                        <figure class="post-media br-sm">
                            <a href="post-single.html">
                                <img src="{{asset('maya')}}/images/demos/demo5/blogs/4.jpg" alt="Post" width="280" height="180"
                ...
                <div class="swiper-wrapper row cols-xl-8 cols-lg-6 cols-md-4 cols-2">
                        ...
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="product-defaproduct-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/3-5.jpg" alt="Category image"
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="product-defaproduct-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/1-1-1.jpg" alt="Category image"
                                        width="130" height="146" style="background-color: #fff" />
                                </a>
                            </figure>
                            <h4 class="product-name">
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="product-defaproduct-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/4-1-1.jpg" alt="Category image"
                                        width="130" height="146" style="background-color: #fff" />
                                </a>
                            </figure>
                            <h4 class="product-name">
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="product-defaproduct-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/2-3.jpg" alt="Category image"
                                        width="130" height="146" style="background-color: #fff" />
                                </a>
                            </figure>
                            <h4 class="product-name">
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="product-defaproduct-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/2-5.jpg" alt="Category image"
                                        width="130" height="146" style="background-color: #fff" />
                                </a>
                            </figure>
                            <h4 class="product-name">
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="product-defaproduct-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/2-8.jpg" alt="Category image"
                                        width="130" height="146" style="background-color: #fff" />
                                </a>
                            </figure>
                            <h4 class="product-name">
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="product-defaproduct-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/3-1-1.jpg" alt="Category image"
                                        width="130" height="146" style="background-color: #fff" />
                                </a>
                            </figure>
                            <h4 class="product-name">
                    ...
                    <div class="swiper-slide product-wrap">
                        <div class="product text-center product-absolute">
                            <figure class="product-media">
                                <a href="product-defaproduct-default.html">
                                    <img src="{{asset('maya')}}/images/demos/demo5/products/1-2.jpg" alt="Category image"
                                        width="130" height="146" style="background-color: #fff" />
                                </a>
                            </figure>
                            <h4 class="product-name">
