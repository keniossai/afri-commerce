            ...
            <ul class="product-nav list-style-none">
                <li class="product-nav-prev">
                    ...
                    <span class="product-nav-popup">
                        <img src="{{asset('maya/images/products/product-nav-prev.jpg')}}" alt="Product" width="110"
                            height="110" />
                ...
                <li class="product-nav-next">
                    ...
                    <span class="product-nav-popup">
                        <img src="{{asset('maya/images/products/product-nav-next.jpg')}}" alt="Product" width="110"
                            height="110" />
                                            ...
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="{{asset('maya/images/shop/product-')}}{{$product->id}}-1.jpg"
                                                        data-zoom-image="{{asset('maya/images/shop/product-')}}{{$product->id}}-1.jpg"
                                                        alt="Bodycare Smooth Powder" width="800" height="900">
                                                </figure>
                                            </div>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="{{asset('maya/images/products/accordion/2-800x900.jpg')}}"
                                                        data-zoom-image="{{asset('maya/images/products/accordion/2-800x900.jpg')}}"
                                                        alt="Bodycare Smooth Powder" width="488" height="549">
                                                </figure>
                                            </div>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="{{asset('maya/images/products/accordion/3-800x900.jpg')}}"
                                                        data-zoom-image="{{asset('maya/images/products/accordion/3-800x900.jpg')}}"
                                                        alt="Bodycare Smooth Powder" width="800" height="900">
                                                </figure>
                                            </div>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="{{asset('maya/images/products/accordion/4-800x900.jpg')}}"
                                                        data-zoom-image="{{asset('maya/images/products/accordion/4-800x900.jpg')}}"
                                                        alt="Bodycare Smooth Powder" width="800" height="900">
                                                </figure>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6 mb-6 mb-md-8">
                                <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                    ...
                                    <div class="product-bm-wrapper">
                                        <figure class="brand">
                                            <img src="{{asset('maya/images/products/brand/brand-1.jpg')}}" alt="Brand" width="102" height="48">
                                        </figure>
                                    ...
                                    <div class="product-meta">
                                        <div class="product-sku">
                                            STATUS: <span style="color: rgb(3, 183, 3); font-size: 15px;">{{$product->stock_status}}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-price">
                                        <ins class="new-price">₦{{$product->regular_price}}</ins>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="banner banner-video product-video br-xs">
                                                <figure class="banner-media">
                                                    <a href="#">
                                                        <img src="{{asset('maya/images/products/video-banner-610x300.jpg')}}"
                                                            ...
                                                            <div class="comment-content">
                                                                ...
                                                                <div class="comment-action">
                                                                    ...
                                                                    <div class="review-image">
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{asset('maya/images/products/default/review-img-1.jpg')}}"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{asset('maya/images/products/default/review-img-1-800x900.jpg')}}" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="comment-content">
                                                                ...
                                                                <div class="comment-action">
                                                                    ...
                                                                    <div class="review-image">
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{asset('maya/images/products/default/review-img-2.jpg')}}"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{asset('maya/images/products/default/review-img-2.jpg')}}" />
                                                                            </figure>
                                                                        </a>
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{asset('maya/images/products/default/review-img-3.jpg')}}"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{asset('maya/images/products/default/review-img-3.jpg')}}" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{asset('maya/images/products/default/review-img-1.jpg')}}"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{asset('maya/images/products/default/review-img-1.jpg')}}" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{asset('maya/images/products/default/review-img-2.jpg')}}"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{asset('maya/images/products/default/review-img-2-800x900.jpg')}}" />
                                                                            </figure>
                                                                        </a>
                                                                        <a href="#">
                                                                            <figure>
                                                                                <img src="{{asset('maya/images/products/default/review-img-3.jpg')}}"
                                                                                    width="60" height="60"
                                                                                    alt="Attachment image of John Doe's review on Electronics Black Wrist Watch"
                                                                                    data-zoom-image="{{asset('maya/images/products/default/review-img-3-800x900.jpg')}}" />
                                                                            </figure>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6 mb-4">
                                            <figure class="vendor-banner br-sm">
                                                <img src="{{asset('maya/images/products/vendor-banner.jpg')}}"
                                        ...
                                        <div class="col-md-6 pl-2 pl-md-6 mb-4">
                                            <div class="vendor-user">
                                                <figure class="vendor-logo mr-4">
                                                    <a href="#">
                                                        <img src="{{asset('maya/images/products/vendor-logo.jpg')}}"
                            ...
                            <div class="swiper-container swiper-theme" data-swiper-options="{
                                ...
                                <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{asset('maya/images/products/default/1-1.jpg')}}" alt="Product"
                                                    width="300" height="338" />
                                                <img src="{{asset('maya/images/products/default/1-2.jpg')}}" alt="Product"
                                                    width="300" height="338" />
                                            </a>
                                    ...
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{asset('maya/images/products/default/2.jpg')}}" alt="Product"
                                                    width="300" height="338" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{asset('maya/images/products/default/3.jpg')}}" alt="Product"
                                                    width="300" height="338" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                    ...
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{asset('maya/images/products/default/4-1.jpg')}}" alt="Product"
                                                    width="300" height="338" />
                                                <img src="{{asset('maya/images/products/default/4-2.jpg')}}" alt="Product"
                                                    width="300" height="338" />
                                            </a>
                                            <div class="product-action-vertical">
                                                <a href="#" class="btn-product-icon btn-cart w-icon-cart"
                                ...
                                <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                    @foreach ($rproducts as $rproduct)
                                        <div class="swiper-slide product">
                                            <figure class="product-media">
                                                <a href="product-default.html">
                                                    <img src="{{asset('maya/images/shop/product-')}}{{$product->id}}-1.jpg" alt="Product"
                                                        width="300" height="338" />
                                                </a>
                                                <div class="product-action-vertical">
                                                    <a href="#" class="btn-product-icon btn-cart w-icon-cart"
